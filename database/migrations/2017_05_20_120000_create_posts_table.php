...
class CreatePostsTable extends Migration
{
    public function up()
    {
        Schema::create('posts', function (Blueprint $table) {
            ...
            $table->foreignId('topic_id')->nullable()->references('id')->on('topics'); // Group blog posts into topics
            $table->foreignId('series_id')->nullable()->references('id')->on('series'); // Group blog posts into series
